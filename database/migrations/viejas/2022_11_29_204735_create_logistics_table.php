...
class CreateLogisticsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('logistics', function (Blueprint $table) {
            $table->id();
            $table->foreignId('transporte_devolucion_id')->constrained('transports')->nullable();
            $table->foreignId('transporte_retiro_id')->constrained('transports')->nullable();
            ...
            $table->text('notas_transporte_devolucion')->nullable();
            $table->text('notas_transporte_retiro')->nullable();
            $table->timestamps();
        });
    }
